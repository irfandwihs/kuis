      ...
      <div className="grid grid-cols-1 gap-4">
        {SHOP_ITEMS.map((item) => {
          ...
          return (
            ...
            >
              <div
                className={`w-16 h-16 ${item.color} rounded-2xl flex items-center justify-center text-3xl shadow-lg group-hover:scale-110 transition-transform`}
              >
                {item.icon}
              </div>
              ...
              <div className="flex-1">
                ...
                <p className="text-brand-navy/60 text-xs font-medium mb-1">
                  {item.description}
                </p>
