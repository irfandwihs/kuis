      ...
      <div className="w-full max-w-md md:max-w-2xl px-4 py-6 md:py-10">
        ...
        >
          ...
          {quiz?.quizType === "duck_hunt" ? (
              ...
              {currentQ.options.map((opt: string, idx: number) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* The Box */}
                    <div
                      className={`w-full p-2 font-mono text-[10px] md:text-xs font-black uppercase leading-tight ${btnClass}`}
            ...
            <div
              className={`grid gap-3 md:gap-4 ${quiz?.quizType === "true_false" ? "grid-cols-2" : "grid-cols-1"}`}
            >
              {currentQ.options.map((opt: string, idx: number) => {
                const isSelected = answers[currentQuestionIdx] === idx;
                const isCorrect = idx === currentQ.correctAnswerIndex;
