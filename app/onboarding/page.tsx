...
const SUBJECTS = ["Matematika", "IPA", "IPS", "Bahasa", "Informatika", "Seni"];
    ...
    <div className="flex flex-col items-center min-h-screen bg-brand-cream">
      <div className="w-full max-w-md md:max-w-2xl px-4 py-8 md:py-12">
        <div className="bg-white rounded-[32px] md:rounded-[48px] shadow-2xl p-6 md:p-12 border border-brand-navy/5">
          <h1 className="text-2xl md:text-4xl font-black text-center mb-2 text-brand-navy tracking-tight">
            Selamat Datang di AksaraPlay!
          </h1>
          <p className="text-center text-brand-navy/60 mb-8 md:mb-12 font-medium">
            Pilih peran Anda untuk melanjutkan. Pilihan ini bersifat permanen.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 mb-8 md:mb-12">
            ...
            >
              <div
                className={`p-4 rounded-2xl mb-4 transition-colors ${selectedRole === "Guru" ? "bg-brand-orange text-white" : "bg-brand-navy/5"}`}
              >
                <BookOpen className="w-10 h-10" />
              </div>
              <h2 className="text-xl font-black">Guru</h2>
              <p className="text-sm text-center mt-2 font-medium opacity-80">
                Buat kuis dan kelola ruangan untuk siswa Anda.
              </p>
            </button>
            ...
            >
              <div
                className={`p-4 rounded-2xl mb-4 transition-colors ${selectedRole === "Siswa" ? "bg-brand-navy text-white" : "bg-brand-navy/5"}`}
              >
                <GraduationCap className="w-10 h-10" />
              </div>
              <h2 className="text-xl font-black">Siswa</h2>
              <p className="text-sm text-center mt-2 font-medium opacity-80">
                Bergabung ke ruangan, kerjakan kuis, dan jelajahi materi.
              </p>
            </button>
          </div>
